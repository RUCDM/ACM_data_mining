 ...
 *
 */
public class CostFunctionPartTwoModel implements CostFunction{
	private int size_;
	...
	public CostFunctionPartTwoModel(int size,
			int miniBatchNum,
			int playerNum,
			int parameterNum,
			int topicNum,
...
//			System.out.println((iteration-1)+" \tprecison:"+value1+"\n-------------");
//			
//		}
//		double value2=calculatePrecisionAfterUpdate(iteration, initial.vector);
//		System.out.println((iteration)+" \tprecison:"+value2+"\n-------------");
